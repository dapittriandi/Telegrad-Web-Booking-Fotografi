...
.banner-btn-solid {
    background:#fff; color:#1E3A8A; border:1px solid transparent;
    font-weight:700;
}
...
/* ── Toggle switch ── */
.toggle-wrap {
    background:var(--tg-glass,#F9FAFB); border:1.5px solid var(--tg-border,#F3F4F6);
...
<div class="porto-banner mb-4">
    <div>
        <h2 class="porto-banner-title"><i class="fa-solid fa-cloud-arrow-up me-2" style="opacity:.8;"></i>Tambah Portofolio Baru</h2>
        <p class="porto-banner-sub">Upload foto dan lengkapi detail untuk ditampilkan di halaman publik.</p>
    </div>
...
<form action="{{ route('portfolios.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
        ...
        <div class="col-lg-4">
            ...
            <div class="tg-card">
                <div class="tg-card-head">
                    <h5><i class="fa-solid fa-image" style="font-size:.82rem;"></i> Upload Gambar</h5>
                </div>
                <div class="tg-card-body">
                    <div class="mb-3">
                        <img id="image-preview" src="" alt="Preview" class="img-fluid w-100"
                             style="max-height:210px;object-fit:cover;border-radius:10px;display:none;margin-bottom:12px;">
                    ...
                    <div>
                        <label class="field-label">File Gambar <span class="req">*</span></label>
        ...
        <div class="col-lg-8">
            ...
            <div class="tg-card">
                <div class="tg-card-head">
                    <h5><i class="fa-solid fa-pencil" style="font-size:.82rem;"></i> Informasi Portofolio</h5>
                </div>
                <div class="tg-card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                  rows="5" placeholder="Deskripsi singkat portofolio...">{{ old('description') }}</textarea>
                    ...
                    <div class="toggle-wrap">
                        ...
                        <p style="font-size:.73rem;color:var(--tg-text-3,#9CA3AF);margin:5px 0 0 28px;">
                            Portofolio nonaktif tidak akan tampil di website customer.
                        </p>
                    </div>
                    ...
                    <div class="d-flex gap-2 justify-content-end mt-4 pt-3" style="border-top:1px solid var(--tg-border,#F3F4F6);">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary" style="border-radius:8px;font-size:.78rem;padding:7px 16px;">
                            <i class="fa-solid fa-floppy-disk me-1"></i> Simpan Portofolio
                        </button>
                    </div>
